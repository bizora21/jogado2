...
const products = [
  {
    ...
    description: "Amassador de alho em aço inoxidável premium. Fácil de usar e limpar, ideal para temperos frescos.",
    price: "850",
    originalPrice: "1200",
    discount: 29,
    image: "/src/assets/amassador-alho.png",
    rating: 5,
    reviews: 47,
    features: [
  ...
  },
  {
    ...
    description: "Cortador multifuncional para todos os tipos de vegetais. Economize tempo na cozinha.",
    price: "1250",
    originalPrice: "1800",
    discount: 31,
    image: "/src/assets/cortador-legumes.png",
    rating: 5,
    reviews: 89,
    features: [
      "Múltiplas funções de corte",
      "Recipiente incluído",
      "Lâminas afiadas"
    ]
  },
  {
    ...
    description: "Escova facial sônica para limpeza profunda. Pele mais limpa e radiante em poucos dias.",
    price: "2100",
    originalPrice: "2800",
    discount: 25,
    image: "/src/assets/escova-facial.png",
    rating: 5,
    reviews: 156,
    features: [
      "Limpeza sônica profunda",
      "Resistente à água",
  ...
  },
  {
    ...
    description: "Massageador portátil para relaxamento. Perfeito para alívio de tensões e stress.",
    price: "1650",
    originalPrice: "2200",
    discount: 25,
    image: "/src/assets/mini-massageador.png",
    rating: 4,
    reviews: 73,
    features: [
      "Design portátil",
  ...
  },
  {
    ...
    description: "Cinta modeladora confortável e respirável. Resultados visíveis imediatamente.",
    price: "950",
    originalPrice: "1400",
    discount: 32,
    image: "/src/assets/cinta-modeladora.png",
    rating: 4,
    reviews: 124,
    features: [
      "Tecido respirável",
...
const testimonials = [
  {
    ...
    name: "Maria Silva",
    location: "Maputo",
    avatar: "/src/assets/avatar-maria.png",
    rating: 5,
    comment: "O cortador de legumes revolucionou minha cozinha! Agora preparo o matapa em metade do tempo. Entrega foi super rápida e o produto chegou em perfeitas condições.",
  ...
  },
  {
    ...
    avatar: "/src/assets/avatar-maria.png",
    rating: 5,
    comment: "A escova facial mudou completamente minha rotina de beleza. Minha pele nunca esteve tão limpa e radiante. Recomendo a todas as mulheres!",
  ...
  },
  {
    ...
    avatar: "/src/assets/avatar-maria.png",
    rating: 5,
    comment: "Excelente atendimento e produtos de qualidade. A cinta modeladora é muito confortável e os resultados são imediatos. Muito satisfeita!",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Descubra nossa seleção premium de produtos domésticos e de bem-estar, 
              testados e aprovados por clientes em todo Moçambique.
            </p>
          </div>
